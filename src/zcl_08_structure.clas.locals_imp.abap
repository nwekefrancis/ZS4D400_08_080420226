...
**********************************************************************
    ...
    TYPES: BEGIN OF st_details,
             DepartureAirpot    TYPE /dmo/airport_from_id,
...
**********************************************************************
    ...
    SELECT SINGLE
      FROM /dmo/i_connection
      FIELDS DepartureAirport, destinationairport, \_airline-name AS AilineName
      WHERE airlineid    = @i_carrier_id
        AND ConnectionID = @i_connection_id
            INTO @Details.
...
**********************************************************************
  ...
  METHOD get_output.
    ...
    APPEND |Departure:   { details-DepartureAirpot }            | TO r_output.
